...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Mathematics!": [["asymptote", "differential", "algorithm", "boolean"],
		...
		"Physics!": [["acceleration", "energy", "current", "declination"],
			["earthshine", "ampere", "quantum", "olivine"], 
			["pyroxene", "temperature", "fermion", "quark"],
			["ampere", "redshift", "inflaton", "collision"],
			["displacement", "exogenesis", "atom", "planck"]],

		"Biology!": [["absorption", "hypothetic", "anabolism", "analogy"],
			["aerobic", "mitosis", "photosynthesis", "prokaryote"],
			["fission", "immunology", "taxonomy", "metabolism"],
			["thorax", "biodiversity", "nutrition", "genetics"],
			["stratosphere", "epidermis", "peritoneum", "capsule"]],

		"Chemistry!": [["alkaline", "hydrochloric", "formic", "carbonil"],
			["omeprazole", "nexium", "chemical", "oxidane"],
			["acetone", "ammonia", "dyson", "electrochemistry"],
			["solutions", "thermodynamics", "equilibrium", "inorganic"],
			["sodium", "phosphorous", "manganese", "matalloid"]],

		"History!": [["taj mahal", "amerfort", "qutub minar", "charminar"],
			["ambedkar", "gandhiji", "janakidevi", "laxmibai"],
			["autobiograpy", "bibliograpy", "geograpy", "prehistoric"],
			["union", "civilization", "republican", "congress"],
			["revolution", "monarchy", "alexander", "independence"]],

		"Geograpy!": [["andaman", "manali", "varanasi", "jaisalmer"],
			["rishikesh", "alleppey", "munnar", "varkala"],
			["jodhpur", "shimla", "gangtok", "darjeeling"],
			["amritsar", "nainital", "mussorie", "pandicherry"],
			["khajuraho", "dalhousie", "haridwar", "mcleodganj"]]
